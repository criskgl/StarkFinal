...
public class CalculateDistance_Syntax {
	...
	*/
	public void testTreeRFG_01() {
		...
		try {
			DistByAxes aba = agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-01.json", 0);
	...
	*/
	public void testTreeRFG_02() {
		AGCCalculator agcc = new AGCCalculator();
		try {
			DistByAxes aba = agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-02.json", 0);
			fail("not yet implemented syntax control in agc calculator");
		} catch (AGCException ex) {
			ex.printStackTrace();
		}
	...
	*/
	public void testTreeRFG_03() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-03.json", 0);
		} catch (AGCException ex) {
	...
	*/
	public void testTreeRFG_04() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-04.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_05() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-05.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, missing \"}\"", message);
	...
	*/
	public void testTreeRFG_06() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-06.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, missing \",\"", message);
	...
	*/
	public void testTreeRFG_07() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-07.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_08() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-08.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_09() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-09.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_10() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-10.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	...
	public void testTreeRFG_11() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-11.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, missing \",\"", message);
	...
	*/
	public void testTreeRFG_12() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-12.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, missing --> : ", message);
	...
	*/
	public void testTreeRFG_13() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-13.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_14() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-14.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_15() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-15.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_16() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-16.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_17() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-17.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	...
	public void testTreeRFG_18() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-18.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, data structure invalid", message);
	...
	*/
	...
	public void testTreeRFG_19() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-19.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	...
	public void testTreeRFG_20() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-20.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	...
	public void testTreeRFG_21() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-21.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_22() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-22.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_23() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-23.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_24() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-24.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, missing [", message);
	...
	*/
	public void testTreeRFG_25() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-25.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_26() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-26.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_27() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-27.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_28() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-28.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
	...
	*/
	public void testTreeRFG_29() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-29.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
		assertEquals("Error: Syntax error, missing \":\" ", message);
	...
	*/
	public void testTreeRFG_30() {
		...
		String message = "";
		try {
			agcc.CalculateDist("/PDS-P5/tests-json/Tree-syntax/T-CP-RFG-30.json", 0);
		} catch (AGCException ex) {
			message = ex.getMessage();
		}
